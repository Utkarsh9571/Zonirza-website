      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col space-y-6">
          <div className="flex items-center space-x-3 border-b border-[#EAE1D5]/10 pb-6">
            ...
            <LinkNext href={settings?.socialLinks?.whatsapp ? `https://wa.me/${settings.socialLinks.whatsapp}` : "#"} target="_blank" className="w-8 h-8 rounded-full border border-[#EAE1D5]/30 flex items-center justify-center hover:bg-white/10 transition-colors text-[#EAE1D5]" title="WhatsApp">
