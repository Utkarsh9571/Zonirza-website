...
import { ShieldCheck, Scale, ScrollText, Gem, Diamond, Award, Heart, Info, Clock, RefreshCw, XCircle, Truck, CreditCard } from 'lucide-react';
import { cn } from '@/lib/utils';

const SECTION_ICON_MAP: Record<string, any> = {
  "Terms & Conditions": ScrollText,
  "Jewellery Guide": Gem,
  "Certification Guide": Award,
  "Diamond and Solitaire Guide": Diamond,
  "Gemstone Guide": Heart,
  "Gifting Guide": Info,
  "Jewellery Care Guide": ShieldCheck,
  "Policies": Scale,
};
        ...
        <div className="space-y-24">
          ...
          <section className="scroll-mt-32" id="terms">
            ...
            <div className="bg-white rounded-[40px] p-8 md:p-12 border border-brand-text/5 shadow-premium space-y-8 text-brand-text/80 leading-relaxed">
              ...
              <div className="p-6 bg-brand-bg rounded-3xl border border-brand-text/5 italic text-sm">
                "Zoniraz.com owner will not be liable and responsible for any loss, damage, personal injury of buyer and third party, whatsoever is the cause."
              </div>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="bg-white p-8 rounded-[32px] border border-brand-text/5 hover:border-brand-gold/30 transition-all group">
                  <care.icon size={32} className="text-brand-gold mb-6 group-hover:scale-110 transition-transform" />
          ...
          <section className="bg-brand-text rounded-[50px] p-12 md:p-16 text-center text-white relative overflow-hidden group">
            <div className="relative z-10 space-y-8">
              ...
              <p className="text-white/60 max-w-xl mx-auto italic">"Our goal is customer satisfaction, not just profit. You can trust in our 50 years of expertise."</p>
              <div className="flex flex-col items-center space-y-4">
                <span className="text-[10px] uppercase tracking-[0.3em] font-bold text-brand-gold">Get in touch with Shantnu</span>
                <a href="tel:9784836060" className="text-3xl font-serif hover:text-brand-gold transition-colors tracking-widest">9784836060</a>
              </div>
            </div>
            {/* Decorative element */}
