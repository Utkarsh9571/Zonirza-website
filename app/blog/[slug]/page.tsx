  ...
  if (!post) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-center">
        <h1 className="text-4xl font-serif text-brand-text mb-4">Story Not Found</h1>
        <Link href="/blog" className="text-brand-gold font-bold uppercase tracking-widest hover:underline">
          Back to Journal
        </Link>
      </div>
    );
