    ...
    { 
      ...
      answer: `<div class="space-y-6 text-sm">
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4 text-[11px] text-brand-text/70">
          ...
          <div>IndusInd Bank</div><div>ING Vysya Bank</div><div>Jammu & Kashmir Bank</div><div>Karnataka Bank Ltd</div><div>Karur Vyas Bank</div>
        ...
        <div class="pt-4 border-t border-brand-text/10">
          ...
          <div class="flex flex-wrap gap-x-4 gap-y-2 text-[11px] text-brand-text/60">
            <span>Karur Vyas</span><span>Lakshmi Vilas</span><span>PNB</span><span>Bank of Maharashtra</span><span>Bank of Baroda</span><span>Bank of India</span><span>SBI</span><span>Union Bank</span>
          </div>
        </div>
      </div>` 
    }
        ...
        <div className="mt-20 p-12 bg-brand-bg rounded-[40px] border border-brand-text/5 text-center relative overflow-hidden group">
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-brand-text/60 max-w-lg mx-auto">
              Our support team is available to help you with your queries about our collections and services.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/contact" className="px-10 py-4 bg-brand-text text-white rounded-full text-[11px] font-bold uppercase tracking-widest hover:bg-brand-gold transition-all">
                Contact Support
              </Link>
            </div>
          </div>
